...
// @match        https://stake.us/casino/games/moles*
// @grant        none
  ...
  function createPanel() {
    ...
    panel.innerHTML = `
      <style>
        ...
        #moles-panel .axis-legend .lg-r { background: #FF00FF; box-shadow: 0 0 4px rgba(255,0,255,0.4); }
        #moles-panel .axis-legend .lg-m { background: #FF3399; box-shadow: 0 0 4px rgba(255,51,153,0.4); }
        ...
        #moles-panel .axis-pill.axis-m.on {
        ...
        #moles-panel .tile-grid {
          display: flex; flex-direction: column; gap: 3px; margin-top: 4px;
        }
        #moles-panel .tile-grid .tile-row {
          display: flex; justify-content: center; gap: 3px;
        }
        #moles-panel .tile-grid .tile {
